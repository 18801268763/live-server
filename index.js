...
LiveServer.start = function(options) {
	...
	let port = options.port !== undefined ? options.port : 65535; // 0 means random
	...
	server.addListener('listening', function(/*e*/) {
		...
		let serveHost = address.address === "0.0.0.0" ? IP_ADDRESS : address.address;
		let openHost = host === "0.0.0.0" ? IP_ADDRESS : host;
